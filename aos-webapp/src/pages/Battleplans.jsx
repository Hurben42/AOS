...
export default function Battleplans() {
  ...
  return (
    <div className="container py-4 min-vh-100">
      <div className="mb-5">
        <Link to="/" className="btn btn-outline-info btn-sm rounded-0 mb-4 px-3">← Retour Accueil</Link>
        
        <div 
          className="p-5 rounded-0 shadow text-center text-md-start border border-info battleplan-header border-opacity-25"
          style={{
